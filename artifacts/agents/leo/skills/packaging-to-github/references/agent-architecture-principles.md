...
*Distilled from {{COMPANY_NAME}} strategy sessions, June 2026. Use when designing SOUL.md, SETUP.md, or agent operating models for any playbook.*
...
- Growth Agent: article hits traffic threshold → analyses performance, proposes follow-up
