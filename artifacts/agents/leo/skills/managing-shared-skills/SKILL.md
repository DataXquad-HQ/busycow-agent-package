...
In a typical local install that resolves to the active Hermes home for the operator running shared-skill governance.
...
`artifacts/shared-skills/` is the right package directory for org-wide reusable skills, and `artifacts/agents/<agent>/skills/` is the right package directory for agent-local runtime copies.
...
- profile-agnostic infrastructure patterns
...
Typical for governance or infrastructure skills.
...
`artifacts/shared-skills/` is the right package directory for org-wide reusable skills.
